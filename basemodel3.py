...
genai.configure(api_key=os.getenv("GOOGLE_API_KEY"))  # Using the API key
...
def main():
    ...
    # Dropdown menu for user to select between "Chat with PDF" and "Chatbot"
    option = st.sidebar.selectbox("Choose your option", ("Chat with PDF", "Talk to Chatbot"))
